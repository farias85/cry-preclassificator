...
public class FIRFilterOverlapAndAdd extends FIRFilterJSTK {

    public FIRFilterOverlapAndAdd(AudioSource source, double[] fir, int min_fft_coefficients) {
        super(source, fir, min_fft_coefficients);
    }

    public FIRFilterOverlapAndAdd(AudioSource source, double[] fir) {
        super(source, fir);
    }
